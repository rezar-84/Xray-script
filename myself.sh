...
function menu() {
    ...
    echo -e "${GREEN}2.${NC} Update (to be done) "
    ...
    echo -e "${GREEN}103.${NC} Revise id"
    echo -e "${GREEN}104.${NC} Revise dest(待办)"
    echo -e "${GREEN}105.${NC} Revise serverNames(待办)"
    echo -e "${GREEN}106.${NC} Revise x25519 key"
    echo -e "${GREEN}107.${NC} Revise shortIds"
    echo -e "${GREEN}108.${NC} Repossess cloudreve account password"
    echo -e "${GREEN}109.${NC} Check cloudreve Original account password"
    echo -e "--------------- other options ---------------"
    echo -e "${GREEN}201.${NC} Update to the latest stable core core"
    echo -e "${GREEN}202.${NC} Uninstall the excess kernel"
    echo -e "${GREEN}203.${NC} Revise ssh port"
